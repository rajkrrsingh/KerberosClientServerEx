...
public class Server {
  ...
  public static void main( String[] args) {
    try {
      ...
      System.setProperty( "java.security.auth.login.config", "/Users/rasingh/workset/JavaSamples/src/main/resources/jaas.conf");
  ...
  private static byte[] loadTokenFromDisk() throws IOException {
    BufferedReader in = new BufferedReader( new FileReader( "/tmp/security.token"));
